...
import com.ksalauyou.weatherapp.domain.usecase.favourite.ObserveFavouriteStateUseCase
import com.ksalauyou.weatherapp.domain.usecase.weather.GetForecastUseCase
import com.ksalauyou.weatherapp.presentation.details.DetailsStore.Intent
...
interface DetailsStore : Store<Intent, State, Label> {
    ...
    sealed interface Intent {
        ...
        data object ClickFavouriteStatus : Intent
    }
