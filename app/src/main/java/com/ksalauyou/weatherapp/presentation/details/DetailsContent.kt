...
import com.ksalauyou.weatherapp.presentation.extensions.formattedFullDate
import com.ksalauyou.weatherapp.presentation.extensions.formattedShortDayOfWeek
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            IconButton(onClick = onClickChangeFavouriteStatus) {
                val icon = if (isCityFavourite) Icons.Default.Star else Icons.Default.StarBorder
                Icon(
                    imageVector = icon,
                    contentDescription = null,
                    tint = MaterialTheme.colorScheme.background
